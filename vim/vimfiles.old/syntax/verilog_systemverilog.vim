...
" Requires:     $VIMRUNTIME/syntax/verilog.vim
"               $VIMRUNTIME/syntax/xml.vim
...
syn keyword verilogStatement   unique priority

syn keyword verilogTodo         contained TODO NOTE FIXME BUG XXX NOTE REVIEW

syn match   verilogCommentTitle contained "[A-Z][A-Za-z0-9_-]\+\s*:"

syn region  verilogComment    start="/\*" end="\*/" contains=verilogTodo,@Spell
syn match   verilogComment    "//.*"                contains=verilogTodo,verilogString,verilogCommentTitle,@Spell
syn match   verilogComment    "///.*"               contains=verilogTodo,verilogString,@Spell
...
if version >= 508 || !exists("did_verilog_syn_inits")
   ...
   HiLink verilogCommentTitle      PreProc
