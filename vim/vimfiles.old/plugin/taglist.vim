...
let s:tlist_def_verilog_systemverilog_settings= 'verilog_systemverilog;m:module;c:class;' .
          \ 't:task;p:program;f:function;i:interface;d:typedef;e:enum;r:parameter;' .
          \ 'a:macro;v:variable;w:process;g:covergroup;q:modport'
