...
" Intel PFM
"-------------------------------------------------------------------------------
syn match   pfmCommentTitle contained "@[A-Za-z0-9_-]\+"
syn keyword pfmType      node wnode t_unibble t_ubyte t_byte t_ushort t_short t_uint t_int t_ulog t_long
syn keyword pfmConstant  TRUE FALSE
syn keyword pfmMethod    flog2 clogb2 bitwidth ceil floor cdiv fdiv uround_div dround_div lpow2 upow2 ispow2 min max
...
if version >= 508 || !exists("did_verilog_syn_inits")
   ...
   HiLink pfmCommentTitle        PreProc
   HiLink pfmType                Type
   HiLink pfmConstant            TypeDef
   HiLink pfmMethod              Function
